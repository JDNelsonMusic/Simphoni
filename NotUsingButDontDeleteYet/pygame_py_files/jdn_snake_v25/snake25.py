...
# Load sound effects
SOUND_EFFECTS = {
    'monsterspawn': pygame.mixer.Sound('sfx.monsterspawn.mp3'),
    'tinypumpkin': pygame.mixer.Sound('sfx.tinypumpkin.mp3'),
    'mediumpumpkin': pygame.mixer.Sound('sfx.mediumpumpkin.mp3'),
    'bigpumpkin': pygame.mixer.Sound('sfx.bigpumpkin.mp3'),
    'redapple': pygame.mixer.Sound('sfx.redapple.mp3'),
    'greenapple': pygame.mixer.Sound('sfx.greenapple.mp3'),
    'ghost': pygame.mixer.Sound('sfx.ghost.mp3'),
    'skeleton': pygame.mixer.Sound('sfx.skeleton.mp3'),
    'zombie': pygame.mixer.Sound('sfx.zombie.mp3'),
}
...
def main(player1_name, player2_name, player1_speed, player2_speed):
    ...
    background_music = pygame.mixer.Sound('twistingfate.mp3')
